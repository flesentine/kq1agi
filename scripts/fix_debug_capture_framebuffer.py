...
# The painterly dialog patch is chained here because this script is already part
# of every browser build. It embeds the transparent generated frame as a dynamic
# nine-slice and leaves AGI message text fully dynamic.
import runpy
runpy.run_path(str(Path(__file__).with_name('add_painterly_dialog_frame.py')), run_name='__main__')

print('Debug capture ready; MOVE SPRITE auto-selects ego, dropped sprites are absolute visual pins, and painterly dialogs are enabled')